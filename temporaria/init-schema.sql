...
-- CreateEnum
CREATE TYPE "CampaignEventType" AS ENUM ('REUNIAO', 'CULTO', 'PANFLETAGEM', 'TREINAMENTO', 'VISITA', 'OUTRO');
...
CREATE TABLE "UserCampaign" (
    ...
    "tier" "CollaboratorTier" NOT NULL DEFAULT 'APOIADOR',
    "invitedBy" TEXT,
...
CREATE TABLE "Collaborator" (
    ...
    "profile" "CollaboratorProfile" NOT NULL DEFAULT 'APOIADOR',
    "supportStatus" "SupportStatus" NOT NULL DEFAULT 'NEUTRO',
    "mobilizationScore" DOUBLE PRECISION,
...
CREATE TABLE "Zone" (
    ...
    "campaignId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "type" "ZoneType" NOT NULL DEFAULT 'MUNICIPAL',
    "parentId" TEXT,
    "color" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Event" (
    ...
    "zoneId" TEXT,
    "title" TEXT NOT NULL,
    "type" "CampaignEventType" NOT NULL DEFAULT 'REUNIAO',
...
CREATE TABLE "Settings" (
    ...
    "campaignName" TEXT NOT NULL DEFAULT 'Base Andre Santos',
    "logoBase64" TEXT,
...
CREATE TABLE "MunicipalityGoal" (
    ...
    "targetLeaders" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
