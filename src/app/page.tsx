...
const PLANS = [
  {
    ...
    highlight: false,
    cta: "Começar grátis",
    features: ["Até 20 membros", "Chamada com QR Code", "Financeiro básico", "Aniversários automáticos", "Portal do membro", "Comunicados"],
  ...
  },
  {
    ...
    price: "R$ 29,99",
    period: "/mês",
    desc: "7 dias grátis — depois R$ 29,99/mês",
    highlight: true,
