            ...
            {activeEvent && (
              <div className="flex flex-col items-center gap-4 py-2">
                ...
                <div className="bg-white p-4 rounded-2xl">
                  <QRCodeSVG
                    value={`${typeof window !== "undefined" ? window.location.origin : ""}/checkin/${activeEvent.id}`}
                    size={220}
                    level="M"
                    includeMargin={false}
                  />
                ...
                <p className="text-xs text-muted-foreground text-center">
                  Exiba este QR na entrada do evento.<br />
                  Os membros escaneiam com a câmera do celular.
                </p>
                <button
                  onClick={() => {
