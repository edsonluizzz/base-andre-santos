...
/** Descarta a sugestão automática (sem marcar a transação como ignorada) — volta a ficar sem sugestão, pra vínculo manual. */
export async function POST(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    console.error("[api/financeiro/extratos/:id/rejeitar POST] erro:", err);
