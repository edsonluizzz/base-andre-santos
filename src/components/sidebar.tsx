...
const navItems = [
  ...
  { href: "/celulas",        icon: Network,          label: "Células",         minRole: "MEMBER", superAdminOnly: false, financeAdminOnly: false, leadsOnly: true  },
  ...
  { href: "/mapa",           icon: Map,              label: "Mapa de Apoio",   minRole: "LEADER", superAdminOnly: false, financeAdminOnly: false, leadsOnly: true  },
...
export function Sidebar({
  ...
  const moduleScope = serverModuleScope ?? (session?.user as { moduleScope?: string })?.moduleScope ?? "full";
  const isLeadsOnly = moduleScope === "leads_only";
  ...
  const finalItems = visibleItems.filter((item) =>
    ...
    (isLeadsOnly ? item.leadsOnly : true) &&
