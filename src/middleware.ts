...
export const config = {
  ...
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|manifest.json|sw.js|icons|ebooks|robots.txt|sitemap.xml|cadastro|material$|material/|ebook|privacidade|descadastro|fotoperfil|r$|r/|api/public|api/cep|.*\\.(?:png|jpg|jpeg|webp|svg|gif)$).*)",
  ],
};
